...
describe('LarawebhookServiceProvider service registration', function () {
    ...
    it('registers SignatureValidator as singleton', function () {
        $instance1 = app(SignatureValidator::class);
    ...
    it('registers WebhookAuditLogWriter as singleton', function () {
        $instance1 = app(WebhookAuditLogWriter::class);
    ...
    it('registers ReplayableWebhookRepository as singleton', function () {
        $instance1 = app(ReplayableWebhookRepository::class);
        $instance2 = app(ReplayableWebhookRepository::class);

        expect($instance1)->toBeInstanceOf(ReplayableWebhookRepository::class)
            ->and($instance1)->toBe($instance2);
    });
