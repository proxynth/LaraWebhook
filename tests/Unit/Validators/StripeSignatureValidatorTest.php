...
describe('StripeSignatureValidator validate', function () {
    ...
    it('throws exception for invalid signature format - missing timestamp', function () {
        $payload = '{"type": "test"}';
        $signatureHeader = incomingSignature('v1=abc123');
    ...
    it('throws exception for invalid signature format - missing v1', function () {
        $payload = '{"type": "test"}';
        $signatureHeader = incomingSignature('t=123456789');
    ...
    it('throws exception for invalid signature', function () {
        ...
        $signatureHeader = incomingSignature("t={$timestamp},v1=abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890");
    ...
    it('validates signature with multiple v1 signatures', function () {
        ...
        $signatureHeader = incomingSignature("t={$timestamp},v1=old_sig,v1={$signature}");
        ...
        $this->validator->validate($payload, $signatureHeader, $this->secret);
